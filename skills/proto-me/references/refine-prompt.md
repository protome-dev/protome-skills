...
Synthesize the Q&A conversation into a short dual-layer product brief. Do not preserve the original prompt verbatim.
...
- Do not use the engineering section as a hidden build plan. It should preserve decision quality for `proto-plan`, not prescribe files, functions, classes, or code structure.
